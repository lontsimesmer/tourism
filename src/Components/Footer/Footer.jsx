  ...
  return (
    <section className={Styles.Footer__component}>
      <div className={Styles.Left__footer}>
        <p className={Styles.Footer__title}>If you have any question,
          Let us help you!
        </p>
        ...
        <p className={Styles.Footer__subscrib}>
          Subscribe to our newspaper
        </p>
        <div className={Styles.Input__area}>
          <input type="text" placeholder='Input your email here' className={Styles.Footer__input} />
      ...
      <div className={Styles.Right__footer}>
        ...
        <p className={Styles.lorem}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
